<template>
  <div class="app-container">
    ...
    <el-button-group>
      <el-button :disabled="!settings.btnShowStatus.showUpdate" type="primary" icon="el-icon-user-solid" :loading="settings.loading" @click="handleUpdate">调整岗位</el-button>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-show="popSettingsData.btnShowStatus.showUpdate && !isViewModel" plain type="primary" :disabled="settings.loading || popSettingsData.btnDisabledStatus.disabledUpdate " @click="doUpdate()">确定</el-button>
